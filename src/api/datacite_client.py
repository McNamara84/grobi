...
class DataCiteClient:
    ...
    def fetch_dois_with_schema_version(self) -&gt; List[Tuple[str, str]]:
        \"\"\"
        Fetch all DOIs with their schema version.
        Uses cursor-based pagination to retrieve all records.
        
        Returns:
            List of tuples containing (DOI, schema_version)
            Schema version format examples: \"4.5\", \"3.1\", \"http://datacite.org/schema/kernel-3\"
    ...
    def _fetch_page_with_schema(self, next_url: Optional[str] = None) -> Tuple[List[Tuple[str, str]], Optional[str]]:
    ...
    def check_schema_4_compatibility(self, doi: str) -> Tuple[bool, Dict[str, Any]]:
        ...
        elif not isinstance(titles, list) or len(titles) == 0:
