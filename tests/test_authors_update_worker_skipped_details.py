...
class TestAuthorsUpdateWorkerSkippedDetails:
    ...
    def test_skipped_details_collected_during_validation(self, qtbot, temp_authors_csv):
        """Test that skipped_details are collected during dry run validation."""
        ...
        with patch('src.workers.authors_update_worker.DataCiteClient') as MockClient:
            ...
            # Return metadata that matches CSV exactly
        ...
        assert "Keine Änderungen" in reason1 or "No changes" in reason1.lower()
    ...
    def test_skipped_details_logging(self, qtbot, temp_authors_csv, caplog):
        ...
        assert "Skipped DOIs (first 5 of 2):" in caplog.text or "Skipping 2 unchanged DOIs:" in caplog.text
